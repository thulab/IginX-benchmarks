...
import (
	...
	"github.com/timescale/tsbs/cmd/tsbs_generate_queries/databases/iginx"
...
func TestGetUseCaseGenerator(t *testing.T) {
	...
	big := iginx.BaseGenerator{}
	igi, err := big.NewDevops(tsStart, tsEnd, scale)
	if err != nil {
		t.Fatalf("Error creating iginx query generator")
	}
	checkType(constants.FormatIginx, igi)
